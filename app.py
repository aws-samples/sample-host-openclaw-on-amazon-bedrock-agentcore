...
agentcore_stack = AgentCoreStack(
    ...
    cognito_password_secret_arn=security_stack.cognito_password_secret.secret_arn,
    ...
    telegram_token_secret_arn=security_stack.channel_secrets["telegram"].secret_arn,
...
router_stack = RouterStack(
    ...
    slack_token_secret_arn=security_stack.channel_secrets["slack"].secret_arn,
    feishu_token_secret_name=security_stack.channel_secrets["feishu"].secret_name,
    feishu_token_secret_arn=security_stack.channel_secrets["feishu"].secret_arn,
